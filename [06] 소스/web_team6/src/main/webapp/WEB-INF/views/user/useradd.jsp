...
<body>
	...
	<div id="signup">
		...
		<form method="POST" action="/web_team6/user/useraddok.do"
			id="signup_form">
			<table>
				<tr>
					<th>아이디</th>
					<td><input type="text" class="form-control"
						placeholder="영문,숫자5자~15자 이내" name="id" id="userId" required pattern="^[a-zA-Z]{1}[a-zA-Z0-9]{5,15}"></td>
					<td><img class="check_icon"
						src="/web_team6/asset/images/check.png" alt="OK" id="idchecktrue"
						style="display: none;"> <img class="remove_icon"
						src="/web_team6/asset/images/remove.png" alt="NO"
						id="idcheckfalse" style="display: none;">
						<button type="button" class="btn btn-default" style="width: 80px;"
							id="userIdCheck">중복확인</button></td>
				...
				<tr>
					...
					<td><input type="password" class="form-control"
						placeholder="영문,숫자5자~15자 이내" name="pw" id="password" required pattern="[a-zA-Z0-9]{5,15}" ></td>

				</tr>
				<tr>
					<th>비밀번호확인</th>
					<td><input type="password" class="form-control"
						placeholder="비밀번호 재확인" name="pw_check" id="pw_check" required ></td>
					<td><img class="check_icon"
						src="/web_team6/asset/images/check.png" alt="OK" id="pw_true"
						style="display: none;"> <img class="remove_icon"
						src="/web_team6/asset/images/remove.png" alt="NO" id="pw_false"
				...
				<tr>
					...
					<td><input type="text" class="form-control" placeholder="이름"
						name="name" required pattern="[가-힣]{2,5}"></td>

				</tr>
				<tr>
					<th>이메일</th>
					<td><input name="email" type="text" class="form-control"
						placeholder="example" required pattern="^[a-zA-Z]{1}[a-zA-Z0-9]{1,15}"><span
						style="margin: 0 5px; padding-top: 5px;">@</span> <input
						type="text" class="form-control" placeholder="직접입력" id="email1"
						name="email1" required pattern="^[a-zA-Z]+(.com|.net)$"></td>
				...
				<tr id="birth">
					<th>생년월일</th>
					<td><input type="text" class="form-control"
						placeholder="년(4자)" name="birth_year" required pattern="[0-9]{4}"> <select
						name="birth_month" style="width: 300px;">
						...
						name="birth_date" required pattern="[0-9]{1,2}"></td>

				</tr>
				<tr>
					<th>성별</th>
					<td><input type="radio" name="gender" value="m"
						style="margin-left: 15px;" checked >남 <input type="radio"
						name="gender" value="w" style="margin-left: 15px;">여</td>

				</tr>
				<tr>
					<th>전화번호</th>
					<td><input name="tel" type="text" class="form-control"
						placeholder="ex) 01012345678" required pattern="[0-9]{10,11}"></td>
			...
			<div id="button">
				<input id="signupButton" type="button" value="가입하기" class="btn btn-primary"> <input
					type="button" value="취소" class="btn btn-group"
	...
	<script>
		...
		$('#signupButton').click(function(){
			if($('#pw_true').css('display')=='inline' && $('#idchecktrue').css('display')=='inline'){
