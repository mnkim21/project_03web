...
<body>
	...
	<div id="page_util">
		<div id="page_util_in">
			<span><img src="/web_team6/asset/images/home-page.png" alt="H"
				class="home_icon" style="width: 15px"></span> <span>&gt;</span> <span>대관문의</span>
		</div>
	</div>
	...
	<div id="top_tag">
		<div id="top_tag_main">
			<img src="/web_team6/asset/images/house-door-fill.svg" id="house_img">
			<p class="top_tag_content">고객센터</p>
			<img src="/web_team6/asset/images/chevron-right.svg" id="chev_right">
			<p class="top_tag_content">대관 문의</p>
		</div>
	</div>
	<div id="main_content">
		<div id="left">
		...
		<div id="right">
				...
				<tr>
					...
					<td>
						<div class="form-group">
							...
							<button type="button" class="btn btn-default" id="add">파일선택</button>
						</div>
					</td>
				</tr>
			...
			<table class="right_table">
				<tr>
					<td>성명</td>
					<td><input type="text" class="content_short" required
						placeholder="성명을 작성하세요."></td>
				</tr>
				<tr id="tel_total">
					<td>연락처</td>
					<td id="tel"><input type="text" class="content_tel">
						<div class="bar"></div> <input type="text" class="content_tel">
						<div class="bar"></div> <input type="text" class="content_tel">
					</td>
				</tr>
				<tr>
			...
			<div id="lowButton">
				...
				<div>
					<input type="button" value="완료" class="btn btn-default" id="btnOk">
				</div>
			</div>
		</div>
	</div>
