   ...
   <div id="page_util">
		<div id="page_util_in">
			<span><img src="/web_team6/asset/images/home-page.png" alt="H"
				class="home_icon" style="width: 15px"></span> <span>&gt;</span> <span>이벤트</span><span>&gt;</span> <span>이벤트 수정하기</span>
		</div>
	</div>
...
<!--  //제이쿼리 ui js -->
 <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
   ...
   <h1 class="page-header"  style="width:1400px;">이벤트 수정</h1>

   <!-- <section class="main-section"> -->

   <div id="event_container">
   
      <form method="POST" action="/cinema/event/eventeditok.do"
         ...
         <table table bordered="1">
            ...
            <tr>
               ...
               <td><input type="text" name="eventtitle" id="eventtitle"
                  class="form-control" value="${dto.eventTitle }" required></td>
            </tr>

            <tr>
               <th>이벤트썸네일</th>
               <td><input type="text" name="eventthumbnail" id="eventthumbnail" 
                  class="form-control" value="${dto.eventThumbnail }" required></td>
            </tr>
				...
				<th>이벤트 등록일</th>
					<td>						
						...
						<input type="text" id="datepicker" name="eventregdate"
								style="width: 200px; height: 30px;" value="${dto.eventRegdate }"autocomplete="off">	
						</p>
					</td>
				</tr>
            ...
            <tr>
               ...
               <td>
	            	<input type="text" id="datepicker2" name="eventstart"
								style="width: 200px; height: 30px;" value="${dto.eventStartdate }" autocomplete="off"> ~
					<input type="text" id="datepicker3" name="eventend"
								style="width: 200px; height: 30px;" value="${dto.eventEnddate }" autocomplete="off">					
				</td>
         ...
         <div id="enroll">
            <input class=btn btn-default button type="submit" value="이벤트수정하기">
         </div>
