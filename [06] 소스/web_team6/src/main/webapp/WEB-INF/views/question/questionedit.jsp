	...
	<div id="page_util">
		<div id="page_util_in">
			<span><img src="/web_team6/asset/images/home-page.png" alt="H"
				class="home_icon" style="width: 15px"></span> <span>&gt;</span> <span>자주묻는질문수정</span>
		</div>
	</div>
			...
			<table>
				...
				<tr>
					...
					<td><input name="answer" type="text" class="form-control"
						placeholder="질문을 입력해주세요." value="${dto.questionTitle }" required pattern="[a-zA-Z0-9가-힣]+"></td>
				</tr>
                <tr>
					<th>답변</th>
					<td><input name="answer" type="text" class="form-control"
						placeholder="답변을 입력해주세요." value="${dto.questionContent }" required pattern="[a-zA-Z0-9가-힣]+"></td>
				</tr>
			</table>

			<div id="button">
				<input id="addButton" type="button" value="수정하기" class="btn btn-primary" style="cursor:pointer;" onclick="location.href='/web_team6/question/questionmain.do';"> 
